...
export const MusicSvg = () => {
  return (
    <View>
      ...
      >
        <Path
          d="M27 2.25C15.75 2.25 6.75 11.25 6.75 22.5V38.25C6.75 40.0402 7.46116 41.7571 8.72703 43.023C9.9929 44.2888 11.7098 45 13.5 45H20.25V27H11.25V22.5C11.25 18.3228 12.9094 14.3168 15.8631 11.3631C18.8168 8.40937 22.8228 6.75 27 6.75C31.1772 6.75 35.1832 8.40937 38.1369 11.3631C41.0906 14.3168 42.75 18.3228 42.75 22.5V27H33.75V45H40.5C42.2902 45 44.0071 44.2888 45.273 43.023C46.5388 41.7571 47.25 40.0402 47.25 38.25V22.5C47.25 11.25 38.1825 2.25 27 2.25Z"
          fill="#822700"
        />
      </Svg>
    </View>
...
export const RewardsIcon = () => (
  <Svg width="12" height="13" viewBox="0 0 12 13" fill="none">
    <Path
      d="M6 2.25V7.525C5.705 7.355 5.365 7.25 5 7.25C3.895 7.25 3 8.145 3 9.25C3 10.355 3.895 11.25 5 11.25C6.105 11.25 7 10.355 7 9.25V4.25H9V2.25H6Z"
      fill="#0E0E0E"
    />
  </Svg>
);
...
export const LikeIcon = () => (
  ...
  >
    <Path
      d="M6.05 9.775L6 9.825L5.945 9.775C3.57 7.62 2 6.195 2 4.75C2 3.75 2.75 3 3.75 3C4.52 3 5.27 3.5 5.535 4.18H6.465C6.73 3.5 7.48 3 8.25 3C9.25 3 10 3.75 10 4.75C10 6.195 8.43 7.62 6.05 9.775ZM8.25 2C7.38 2 6.545 2.405 6 3.04C5.455 2.405 4.62 2 3.75 2C2.21 2 1 3.205 1 4.75C1 6.635 2.7 8.18 5.275 10.515L6 11.175L6.725 10.515C9.3 8.18 11 6.635 11 4.75C11 3.205 9.79 2 8.25 2Z"
      fill="#0E0E0E"
    />
  </Svg>
);
